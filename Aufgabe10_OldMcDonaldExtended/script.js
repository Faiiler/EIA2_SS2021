...
(function (L09_OldMcDonaldsFarm) {
    ...
    */
    ...
    function makeAnimals() {
        animalArr.push(new L09_OldMcDonaldsFarm.Cat("Bella", "cat", "meat", 2, "meow", foodStorage));
        animalArr.push(new L09_OldMcDonaldsFarm.Dog("Niko", "dog", "meat", 3, "niko-niko-nii", foodStorage));
        animalArr.push(new L09_OldMcDonaldsFarm.Catgirl("Shiro", "catgirl", "sweets", 10, "nya~", foodStorage));
        animalArr.push(new L09_OldMcDonaldsFarm.Rabbit("Pfote", "rabbit", "carrot", 3, "nom-nom", foodStorage));
        animalArr.push(new L09_OldMcDonaldsFarm.Horse("Daily", "horse", "weed", 5, "wheeeaaa", foodStorage));
        animalArr.push(new L09_OldMcDonaldsFarm.Human("Eva", "human", "sushi", 5, "omae wa mo shindeiru", foodStorage));
    }
    function foodNeeded() {
